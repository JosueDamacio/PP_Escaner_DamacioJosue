namespace PP_Escaner_DamacioJosue
{
    public class Class1
    {
...
{
    Console.WriteLine("Esta estrctura es solo de prueba, y no es de mi propiedad");
    ...
    Console.WriteLine();
    Console.WriteLine($"Agrego el mismo Libro: libro es igual ? True: {l1 == l2}");
    Console.WriteLine($"Agrego distinto Libro: libro es igual ? False: {l1 == l3}");

    Console.WriteLine();
    Console.WriteLine($"Se puede agregar un libro Igual al escaner ? False: " +
                      $"{escanerLibro + l2}   ------------  falta arreglar");

    Console.WriteLine($"Se puede agregar un libro  distinto al escaner ? True: " +
                      $"{escanerLibro + l3}");

    Console.WriteLine();
    Console.WriteLine($"Pruebo == de escaner, comparo el mismo libro a la lista True: " +
                      $"{escanerLibro == l1}");

    Console.WriteLine($"Pruebo == de escaner, comparo un libro distinto a la lista False: " +
                      $"{escanerLibro == l4}");
    Console.WriteLine($"Pruebo == de escaner, con un mapa False: {escanerLibro == mapa}");
    ...
    Console.WriteLine();
    Console.WriteLine($"Se puede agregar el libro Distribuido al escaner ? False: " +
                      $"{escanerLibro + l4}  ------------  falta arreglar");

    Console.WriteLine();
    Console.WriteLine($"Sepuede agregar un mapa al escaner de libros ? False:{escanerLibro + mapa} --- falta arreglar");
    ...
    Console.WriteLine("//////////////////////////////////////////////////");
    Console.WriteLine("///////////////////////// 2 ////////////////////////--------------------");
    Console.WriteLine("-----------------(l6 no se mostró)----------------");

    // Llamar al metodo MostrarEnRevision
    Informes.MostrarEnRevisión(escanerLibro, out extension, out cantidad, out resumen);
    Console.WriteLine();
    ...
    Console.WriteLine("//////////////////////////////////////////////////");
    Console.WriteLine("///////////////////////// 3 ////////////////////////--------------------");
    Console.WriteLine("-----------------se muestra y tambien se muestra l6----------------");
    Console.WriteLine("-------------------(l6 se debio mostrar antes)---------------");
